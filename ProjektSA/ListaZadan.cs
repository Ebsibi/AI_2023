...
namespace Projekt_AI
{
    internal class Zadanie : ICloneable
    {
        ...
        public Zadanie(int IdZadania, int CzasWykonaniaZadania, int? PoprzednieZadanie = null)
        {
        ...
        {
            return new Zadanie(this.IdZadania, this.CzasWykonaniaZadania, this.PoprzednieZadanie);
        }
